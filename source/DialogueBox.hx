...
class DialogueBox extends FlxSpriteGroup
{
	...
	case 'lo-fight' | 'overhead' | 'ballistic':
		...
		portraitRight.frames = FlxAtlasFrames.fromSparrow('assets/images/bonusWeek/boyfriendPort.png', 'assets/images/bonusWeek/boyfriendPort.xml');
