...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'lo-fight':
				dialogue = CoolUtil.coolTextFile('assets/data/lo-fight/pleaseSubscribe.txt');
			case 'overhead':
				dialogue = CoolUtil.coolTextFile('assets/data/overhead/pleaseSubscribe.txt');
			case 'ballistic':
				dialogue = CoolUtil.coolTextFile('assets/data/ballistic/pleaseSubscribe.txt');
		}
	...
	function whittyAnimation(?dialogueBox:DialogueBox):Void
			{
				...
				switch(curSong.toLowerCase()) // WHITTY ANIMATION CODE LMAOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
				{
					case 'ballistic':
						...
						var wind:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/windLmao' + TitleState.soundExt, true);
						var mBreak:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/micBreak' + TitleState.soundExt);
						var mThrow:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/micThrow' + TitleState.soundExt);
						var mSlam:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/slammin' + TitleState.soundExt);
						var TOE:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/ouchMyToe' + TitleState.soundExt);
						var soljaBOY:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/souljaboyCrank' + TitleState.soundExt);
						var rumble:FlxSound = new FlxSound().loadEmbedded('assets/sounds/ballisticcut/rumb' + TitleState.soundExt);
		
						remove(dad);
						var animation:FlxSprite = new FlxSprite(-480,-100);
						animation.frames = FlxAtlasFrames.fromSparrow('assets/images/bonusWeek/cuttinDeezeBalls.png', 'assets/images/bonusWeek/cuttinDeezeBalls.xml');
					...
					case 'lo-fight':
						...
						animation.frames = FlxAtlasFrames.fromSparrow('assets/images/bonusWeek/whittyCutscene.png', 'assets/images/bonusWeek/whittyCutscene.xml');
						...
						var city:FlxSound = new FlxSound().loadEmbedded('assets/sounds/lofightcut/city' + TitleState.soundExt, true);
						var rip:FlxSound = new FlxSound().loadEmbedded('assets/sounds/lofightcut/rip' + TitleState.soundExt);
						var fire:FlxSound = new FlxSound().loadEmbedded('assets/sounds/lofightcut/fire' + TitleState.soundExt);
						var BEEP:FlxSound = new FlxSound().loadEmbedded('assets/sounds/lofightcut/beepboop' + TitleState.soundExt);
						city.fadeIn();
