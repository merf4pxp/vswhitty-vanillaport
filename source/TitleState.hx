...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		gfDance = new FlxSprite(685, 5);
		gfDance.frames = FlxAtlasFrames.fromSparrow('assets/images/bonusWeek/whittyDanceTitle.png', 'assets/images/bonusWeek/whittyDanceTitle.xml');
		gfDance.animation.addByPrefix('idle', 'Whitty Dancing Beat', 24);
		gfDance.antialiasing = true;
		add(gfDance);
		add(logoBl);

		titleText = new FlxSprite(115, FlxG.height * 0.8);
	...
	override function beatHit()
	{
		...
		{
			case 1:
				createCoolText(['sockclip', 'nate anim', 'kadedev', 'and the fnf team']);
			...
			// credTextShit.screenCenter();
			case 9:
				createCoolText(['source code in']);
			// credTextShit.visible = true;
			case 10:
				addMoreText('merf4pxp');
			case 11:
				addMoreText('github');
			// credTextShit.text += '\nlmao';
			case 12:
